      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        <div className="max-w-7xl mx-auto p-6 pt-6 space-y-6 pb-24">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-black text-foreground italic tracking-tighter uppercase leading-none select-none flex items-center gap-4">
          ...
          {(!isLoading && !user && isCritical) && (
            <div className="absolute inset-0 bg-background/80 backdrop-blur-2xl z-50 flex items-center justify-center p-8 animate-in fade-in duration-700">
