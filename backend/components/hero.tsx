      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        >
          ...
          >
            ...
            >
              <Lock className="h-12 w-12 text-secondary drop-shadow-lg" />
            </motion.div>
            <motion.div
              animate={{
                rotateY: [0, 360],
            ...
            >
              <FileCheck className="h-12 w-12 text-accent drop-shadow-lg" />
            </motion.div>
          </motion.div>
        </motion.div>
        ...
        <motion.h1
          ref={titleRef}
          className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent mb-6 text-balance leading-tight"
          initial={{ opacity: 0 }}
