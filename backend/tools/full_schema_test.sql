...
-- ### MIGRATION: 20241004120000_create_system_configs.sql ###
...
-- ### MIGRATION: 20241004120001_create_users.sql ###
...
-- ### MIGRATION: 20241004120011_create_documents.sql ###
-- ==============================
...
-- ### MIGRATION: 20241004120021_create_ntkr_transactions.sql ###
-- ==============================
...
-- ### MIGRATION: 20241004120031_add_users_deactivated.sql ###
...
-- ### MIGRATION: 20241004120041_update_schema_for_business_logic.sql ###
...
-- ### MIGRATION: 20241004120042_missing_baselines.sql ###
...
-- ### MIGRATION: 20241004120051_fix_enum_and_column_additions.sql ###
...
-- ### MIGRATION: 20241004120061_blockchain_logical_crud.sql ###
...
-- ### MIGRATION: 20241004120091_add_name_and_wallet_required.sql ###
...
-- ### MIGRATION: 20241004120092_add_note_to_ntkr_transactions.sql ###
...
-- ### MIGRATION: 20241004120093_add_approval_to_tx_type_enum.sql ###
...
-- ### MIGRATION: 20241004120095_update_amount_constraint_for_approval.sql ###
...
-- ### MIGRATION: 20241004120096_add_liveness_fields_to_users.sql ###
...
-- ### MIGRATION: 20260106174501_add_audit_trail_to_documents.sql ###
...
-- ### MIGRATION: 20260115_create_ntk_mint_audit.sql ###
...
-- ### MIGRATION: 20260115_add_server_computed_flag.sql ###
...
-- ### MIGRATION: 20260116_create_governance_tables.sql ###
DO $$ BEGIN
...
-- ### MIGRATION: 20260117_create_notary_applications.sql ###
...
-- ### MIGRATION: 20260117_add_nationality_to_notary_apps.sql ###
ALTER TABLE notary_applications ADD COLUMN IF NOT EXISTS nationality VARCHAR(100);


-- ### MIGRATION: 20260117_update_notary_apps_standalone.sql ###
...
-- ### MIGRATION: 20260122_hygiene_hardening.sql ###
-- ============================================
...
-- ### MIGRATION: 20260124_create_auth_nonces.sql ###
...
-- ### MIGRATION: 20260124_create_token_audit_logs.sql ###
...
-- ### MIGRATION: 20260124_fix_notary_apps_status.sql ###
...
-- ### MIGRATION: 20260205_remote_auth.sql ###
...
-- ### MIGRATION: 20260205000001_rename_kyc_status_to_liveness_status.sql ###
DO $$ 
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'users' AND column_name = 'kyc_status') THEN
...
-- ### MIGRATION: 20260211_add_document_metadata.sql ###
...
-- ### MIGRATION: 20260211_fix_ntk_amount_overflow.sql ###
...
-- ### MIGRATION: 20260211000001_fix_is_deleted_column.sql ###
...
-- ### MIGRATION: 20260211000002_update_proposal_types.sql ###
...
-- ### MIGRATION: 20260211100003_add_summary_fingerprint.sql ###
...
-- ### MIGRATION: 20260219_create_token_deposits.sql ###
...
-- ### MIGRATION: 20260223_add_proposal_targeting.sql ###
...
-- ### MIGRATION: 20260223_remote_gov_sessions.sql ###
...
-- ### MIGRATION: 20260319_reputation_system.sql ###
-- ====================================================
...
-- ### MIGRATION: 20260319_wallet_normalization.sql ###
...
-- ### MIGRATION: 20260324_task_consistency_v3.sql ###
...
-- ### MIGRATION: 20260328_cleanup_identity_schema.sql ###
